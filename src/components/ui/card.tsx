...
>(({ className, gradient = false, glow = false, hover = true, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
...
>(({ className, featured = false, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "group relative overflow-hidden rounded-xl border bg-card text-card-foreground shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2",
